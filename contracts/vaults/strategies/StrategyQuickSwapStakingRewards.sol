...
contract StrategyQuickSwapStakingRewards is StratManager, FeeManager {
    ...
    function balanceOfPool() public view returns (uint256) {
        return IStakingRewards(chef).balanceOf(address(this));
    }
    ...
    function rewardsAvailable() public view returns (uint256) {
        return IStakingRewards(chef).earned(address(this));
    }
